  I did this project to get acquainted to the used tools (Selenium Webdriver to automate the test (with Javascript) and Cucumber to write the result (with Gherkin)).
